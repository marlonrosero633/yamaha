    ...
    <div class="cards-grid">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_DT175; ?></h1>
                    <p><?php echo $desc_dt175; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Fz150; ?></h1>
                    <p><?php echo $desc_fz150; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Mt09; ?></h1>
                    <p><?php echo $desc_mt09 ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Mt15 ; ?></h1>
                    <p><?php echo $desc_mt15 ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Niken; ?></h1>
                    <p><?php echo $desc_niken ; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Nmax ; ?></h1>
                    <p><?php echo $desc_Nmax ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_R1 ; ?></h1>
                    <p><?php echo $desc_r3 ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Traizer ; ?></h1>
                    <p><?php echo $desc_traizer ; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cards-grid">
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Xt660 ;?></h1>
                    <p><?php echo $desc_xt660 ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo  $nombre_Xtz250 ;?></h1>
                    <p><?php echo $desc_xtz250 ; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                ...
                <div class="flip-card-back">
                    <h1><?php echo $nombre_Yz250 ; ?></h1>
                    <p><?php echo $desc_yz250 ; ?></p>
                </div>
            </div>
        </div>
    </div>
